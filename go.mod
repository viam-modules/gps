...
// ginkgolinter v0.20.0+ removed the "types" subpackage that golangci-lint v1.62.0 imports.
// Use v0.19.1 which has the types subpackage and is API compatible.
replace github.com/nunnatsa/ginkgolinter => github.com/nunnatsa/ginkgolinter v0.19.1

// golangci/gofmt restructured its packages after 20250106; golangci-lint v1.62.0 needs the
// older version which still has the "goimports" subpackage.
replace github.com/golangci/gofmt => github.com/golangci/gofmt v0.0.0-20240816233607-d8596aa466a9
