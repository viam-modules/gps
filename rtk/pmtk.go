...
// Package rtk implements a gps. This file is for connecting to the chip over I2C.
package rtk
...
// ModelPmtk for viam supported gps rtk-pmtk movement sensor.
var ModelPmtk = resource.NewModel("viam", "gps", "rtk-pmtk")
